...
export default class TabMenuNavigationBar extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selectedTab: 'Event'
                ...
                <TabNavigator>
                    <TabNavigator.Item
                        ...
                        <View style={styles.page0}>
                            <Text style={{fontSize:18,padding:15,color: 'blue'}}>This is Event1 Page</Text>
                        </View>
                    </TabNavigator.Item>
                    <TabNavigator.Item
...
module.exports = TabMenuNavigationBar
// AppRegistry.registerComponent('TabMenuNavigationBar', () => TabMenuNavigationBar);